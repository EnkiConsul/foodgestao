  ...
  for (const colab of porNome) {
    ...
    doColab.forEach((p, idx) => {
      ...
      linhas.push({
        ...
        fimAquisitivo: p.fim_aquisitivo,
        gozoInicio: gozoRef && !gozoFimOuFuturo ? gozoRef.data_inicio : gozoRef?.data_inicio ?? null,
        gozoDias: gozoRef?.dias ?? null,
        gozoAbono: gozoRef && gozoRef.dias_abono > 0 ? gozoRef.dias_abono : gozoRef ? gozoRef.dias_abono : null,

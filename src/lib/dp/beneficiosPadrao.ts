...
const ROTULOS: Record<CampoPadrao, string> = {
  ...
  vale_transporte_dia_pagamento: "Dia do pagamento do VT",
  vale_transporte_dias_corte: "Corte do VT (dias)",
  vale_transporte_desconta_falta: "VT desconta falta",
  vale_transporte_desconta_folga_extra: "VT desconta folga extra",
  vale_transporte_desconta_atestado: "VT desconta atestado",
  vale_transporte_desconta_ferias: "VT desconta férias",
  vale_alimentacao_dia_pagamento: "Dia do pagamento do VA",
  vale_alimentacao_dias_corte: "Corte do VA (dias)",
  vale_alimentacao_desconta_falta: "VA desconta falta",
  vale_alimentacao_desconta_folga_extra: "VA desconta folga extra",
  vale_alimentacao_desconta_atestado: "VA desconta atestado",
  vale_alimentacao_desconta_ferias: "VA desconta férias",

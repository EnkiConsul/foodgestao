...
export default function DpPage() {
  return (
    <SiteLayout breadcrumbs={[{ name: "DP 360°", path: "/departamento-pessoal" }]}>
      <SiteSeo
        title="DP 360° — Departamento pessoal para bares e restaurantes"
      ...
      <section className="bg-gradient-site-hero text-white" aria-labelledby="dp-hero">
        <div className="site-container grid items-center gap-12 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <Eyebrow tone="dark">DP 360°</Eyebrow>
      ...
      <PillarsSection
        eyebrow="O que o DP 360° resolve"
      ...
      <Section labelledBy="dp-planos-title">
        <SectionHeading
          ...
          description="Os planos do DP 360° consideram o número de colaboradores e unidades da operação."
        />

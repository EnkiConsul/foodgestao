...
function FeaturesGrid() {
  return (
    <section id="recursos" className="border-t border-border/60 bg-muted/30 py-20 lg:py-24">
...
function FaqSection() {
  return (
    <section id="faq" className="border-t border-border/60 bg-muted/30 py-20 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-wider text-primary">Perguntas frequentes</p>
          <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">Tire suas dúvidas</h2>
        </div>

...
import { Building2, Clock, Info, Plus, Search, Tags, Trash2 } from "lucide-react";

import { supabase } from "@/integrations/supabase/client";
import { useCompanyContext } from "@/hooks/useCompanyContext";
import { DpFilterCard, DpEmptyState } from "@/components/dp/DpPage";
...
/**
 * Turnos de jornada dos colaboradores, exibidos como aba de Cargos e Salários.
 * O horário de funcionamento da loja continua em Unidades > Funcionamento.
 */
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 rounded-lg border border-dashed bg-muted/40 p-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-xs text-muted-foreground">
          Turnos de jornada dos colaboradores. O horário de funcionamento da loja fica em{" "}
          <strong>Unidades</strong>.
        </p>
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" size="sm" onClick={() => navigate("/dp/cadastros/unidades")}>
      ...
      <AlertDialog open={limpezaOpen} onOpenChange={(o) => !o && setLimpezaOpen(false)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Nenhum deles está vinculado a colaborador, escala, convocação ou cobertura mínima.

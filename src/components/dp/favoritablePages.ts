...
import {
  ...
  Calendar, Repeat, CheckSquare, Building2, Briefcase, HandshakeIcon, Ban, CalendarX,
...
export const FAVORITABLE_PAGES: FavoritablePage[] = [
  ...
  { pattern: "/dp/cadastros/negociacoes-sindicais", label: "Negociações Sindicais", icon: FileSignature },

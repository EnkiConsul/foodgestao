...
export function CookieConsentBanner() {
  ...
  return (
    <>
      {!decided && !hidden && (
        <div
          className="fixed inset-x-3 z-[60] sm:inset-x-auto sm:right-4 sm:bottom-4 sm:max-w-md max-sm:max-h-[32vh] max-sm:overflow-y-auto"
          // No celular o aviso precisa ficar ACIMA da barra de navegação
          // inferior (64px + área segura), senão cobre o botão de início.

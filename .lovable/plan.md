...
## Verificação
- Conferir visualmente em celular, tablet e desktop que a pessoa e o aparelho aparecem inteiros.
- Confirmar que o formulário está menor, translúcido, centralizado na área livre e sem sobreposições.
- Validar login, cadastro, recuperação, confirmação e MFA com os testes existentes.

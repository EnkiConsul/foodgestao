...
"Pessoas Registradas no Dia" passa a se chamar **"Adicionar Pessoa no Dia"**, com a descrição ajustada para dizer que ali ficam as pessoas incluídas manualmente naquele dia (para editar ou remover).

...
- Aba `Padrões`: reusar o diálogo/painel de padrão de remuneração já usado em `ColaboradorFormDialog.tsx` com `useDpBeneficiosPadroes` / `useSalvarDpBeneficiosPadrao`; sem novos campos nem novas tabelas.

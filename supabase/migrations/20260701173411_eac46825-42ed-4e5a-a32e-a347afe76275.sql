...
DROP FUNCTION IF EXISTS public.get_accessible_accounts(context_type, uuid);
...
GRANT EXECUTE ON FUNCTION public.get_accessible_accounts(context_type, uuid, boolean) TO authenticated;

-- Fase 5: correção de chamadas inválidas de verificação de permissão.
-- A variante de 1 argumento de is_company_admin_or_owner não existe, então a
-- troca direta de folga falhava sempre em tempo de execução.

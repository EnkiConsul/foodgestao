...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'integracoes', jsonb_build_object(
      ...
      'pluggy_webhooks_pendentes', (SELECT count(*) FROM public.pluggy_webhook_events WHERE processed_at IS NULL AND error IS NULL),
      'pluggy_webhooks_dead_letter', (SELECT count(*) FROM public.pluggy_webhook_events WHERE error IS NOT NULL),

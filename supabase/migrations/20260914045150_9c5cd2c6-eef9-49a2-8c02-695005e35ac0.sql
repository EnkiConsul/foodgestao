...
DROP FUNCTION IF EXISTS public.dp_conformidade_autofill() CASCADE;
DROP FUNCTION IF EXISTS public.dp_ponto_ajuste_aplicar() CASCADE;
DROP FUNCTION IF EXISTS public.dp_ponto_competencia_fechada() CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_gerar_transaction() CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_gerar_lancamentos(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_reabrir_periodo(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_enviar_financeiro(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_desfazer_despesa(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.dp_folha_gerar_despesa(uuid, uuid, uuid, date) CASCADE;
DROP FUNCTION IF EXISTS public.dp_beneficios_gerar_lancamentos(uuid) CASCADE;

DROP TABLE IF EXISTS public.dp_ponto_ajustes CASCADE;
DROP TABLE IF EXISTS public.dp_ponto_fechamentos CASCADE;
DROP TABLE IF EXISTS public.dp_pontos CASCADE;
DROP TABLE IF EXISTS public.dp_folha_lancamentos CASCADE;
DROP TABLE IF EXISTS public.dp_folha_periodos CASCADE;
DROP TABLE IF EXISTS public.dp_exames_aso CASCADE;
DROP TABLE IF EXISTS public.dp_epis_entregas CASCADE;
DROP TABLE IF EXISTS public.dp_epis CASCADE;
DROP TABLE IF EXISTS public.dp_treinamentos_participacoes CASCADE;
DROP TABLE IF EXISTS public.dp_treinamentos CASCADE;

DROP TYPE IF EXISTS public.dp_ponto_tipo;
DROP TYPE IF EXISTS public.dp_ponto_origem;
DROP TYPE IF EXISTS public.dp_ponto_ajuste_acao;
DROP TYPE IF EXISTS public.dp_exame_tipo;
DROP TYPE IF EXISTS public.dp_exame_resultado;
DROP TYPE IF EXISTS public.dp_treinamento_status;
DROP TYPE IF EXISTS public.dp_folha_periodo_status;
DROP TYPE IF EXISTS public.dp_folha_lancamento_status;

UPDATE public.app_hidden_screens SET routes = '{}'::text[], updated_at = now();
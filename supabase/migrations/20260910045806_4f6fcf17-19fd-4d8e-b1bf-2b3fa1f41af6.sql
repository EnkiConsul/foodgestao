CREATE OR REPLACE FUNCTION public.dp_convocacao_publicar_grupo(p_grupo_id uuid, p_expected_updated_at timestamp with time zone, p_confirmacoes jsonb DEFAULT '[]'::jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
  ...
  LOOP
    ...
    IF v_grupo.modalidade = 'individual' THEN
      ...
      VALUES (
        ...
        v_aval->>'compatibilidade',
        NULLIF(v_aval->>'regime_snapshot', '')::public.dp_regime_trabalho,
        v_aval->'remuneracao_snapshot', v_tz,

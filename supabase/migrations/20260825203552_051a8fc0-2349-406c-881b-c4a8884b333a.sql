...
REVOKE ALL ON FUNCTION public.pluggy_confirm_staging_card(uuid[], uuid, uuid, uuid, uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.pluggy_confirm_staging_card(uuid[], uuid, uuid, uuid, uuid) TO authenticated;
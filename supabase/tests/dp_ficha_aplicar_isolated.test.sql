...
BEGIN
  ...
  INSERT INTO public.dp_colaborador_config_dias
    (company_id, colaborador_id, config_id, dow, trabalha, entrada, saida)
  VALUES (f.company_a, f.colab_existente, v_cfg, 1, true, '07:00', '16:00'),
         (f.company_a, f.colab_existente, v_cfg, 2, true, '07:00', '16:00');
